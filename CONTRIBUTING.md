# Contributing to lightsheet_simulator
...
[GitHub issue](https://github.com/gddickinson/lightsheet_simulator/issues) rather than emailing —
...
2. **What happened** versus what you expected. Paste the full traceback if there
   was one.
3. **Your data** — the simulation parameters and the intended downstream pipeline.
